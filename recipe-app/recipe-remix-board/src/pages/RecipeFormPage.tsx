          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground leading-7">
                {existing
                  ? "Update your recipe information below and save the changes."
                  : "Create a delicious recipe by filling out the information below. Add ingredients, instructions, and dietary-friendly substitutions."}
              </p>
